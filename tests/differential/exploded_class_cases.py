...
EXPLODED_CLASS_SPECS["random.Generator.permuted"] = ItemSpec(
    ...
    custom_cases=lambda: [
        ...
        ("len0", (42, []), {}),
        ("floats", (42, [0.5, 1.5, 2.5, 3.5, 4.5]), {}),
        ("nd2_axis0", (4, [list(range(4)), list(range(4, 8)), list(range(8, 12))]), {"axis": 0}),
        ("nd2_axis1", (4, [list(range(4)), list(range(4, 8)), list(range(8, 12))]), {"axis": 1}),
    ],
...
EXPLODED_CLASS_SPECS["random.Generator.choice"] = ItemSpec(
    ...
    custom_cases=lambda: [
        ...
        ("nd_a_axis0", (6, [list(range(4)), list(range(4, 8)), list(range(8, 12))]), {"size": 2, "replace": False, "axis": 0}),
    ],
